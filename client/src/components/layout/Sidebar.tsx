    ...
    <aside className="sidebar">
      ...
      <nav>
        ...
        <ul className="nav-links">
          <li className={`nav-item ${activeTab === 'program-tower' ? 'active' : ''}`} onClick={() => setActiveTab('program-tower')}>
          ...
          <li className={`nav-item ${activeTab === 'dashboard' ? 'active' : ''}`} onClick={() => setActiveTab('dashboard')}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" /></svg>
            ダッシュボード
          </li>
        </ul>
        ...
        <ul className="nav-links">
          ...
          <li className={`nav-item ${activeTab === 'artifacts' ? 'active' : ''}`} onClick={() => setActiveTab('artifacts')}>
        ...
        <div className="nav-section-title">Execution</div>
        <ul className="nav-links">
          <li className={`nav-item ${activeTab === 'issues' ? 'active' : ''}`} onClick={() => setActiveTab('issues')}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" /></svg>
            課題ボード
          </li>
          <li className={`nav-item ${activeTab === 'test-items' ? 'active' : ''}`} onClick={() => setActiveTab('test-items')}>
          ...
          <li className={`nav-item ${activeTab === 'defects' ? 'active' : ''}`} onClick={() => setActiveTab('defects')}>
        ...
        <div className="nav-section-title">Quality & Assets</div>
        <ul className="nav-links">
          ...
          <li className={`nav-item ${activeTab === 'weekly-reports' ? 'active' : ''}`} onClick={() => setActiveTab('weekly-reports')}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg>
            週次報告
          </li>
          ...
          <li className={`nav-item ${activeTab === 'wiki' ? 'active' : ''}`} onClick={() => setActiveTab('wiki')}>
