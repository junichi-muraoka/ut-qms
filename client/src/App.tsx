        ...
        {activeTab === 'dashboard' && (
          <div className="dashboard-grid" style={{display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '1.5rem'}}>
            <div className="card" style={{textAlign: 'center', padding: '2rem'}}>
              ...
              <div style={{fontSize: '2.5rem', fontWeight: 'bold', margin: '0.5rem 0'}}>{stats.totalTests}</div>
              <div style={{fontSize: '0.8rem', color: 'var(--success-color)'}}>実施済み</div>
            </div>
            <div className="card" style={{textAlign: 'center', padding: '2rem'}}>
              <h3 style={{color: 'var(--text-secondary)', fontSize: '0.9rem'}}>テスト合格率</h3>
              <div style={{fontSize: '2.5rem', fontWeight: 'bold', margin: '0.5rem 0', color: 'var(--primary-color)'}}>
                {stats.testPassRate.toFixed(1)}%
              </div>
              <div className="progress-bar" style={{height: '8px', background: '#eee', borderRadius: '4px', overflow: 'hidden'}}>
            ...
            <div className="card" style={{textAlign: 'center', padding: '2rem'}}>
              ...
              <div style={{fontSize: '2.5rem', fontWeight: 'bold', margin: '0.5rem 0', color: stats.openDefects > 0 ? 'var(--error-color)' : 'var(--success-color)'}}>
                {stats.openDefects}
              </div>
